            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 sm:p-8 transform transition-all duration-300 scale-100 opacity-100">
                ...
                <div className="mb-6">
                    ...
                    <input
                        ...
                        className="w-full p-3 border border-gray-300 rounded-xl focus:ring-purple-500 focus:border-purple-500 transition-shadow"
                    />
                </div>
                ...
                <div className="mb-8">
                    ...
                    <textarea
                        ...
                        rows={4}
                        className="w-full p-3 border border-gray-300 rounded-xl focus:ring-purple-500 focus:border-purple-500 transition-shadow resize-none placeholder-gray-400"
